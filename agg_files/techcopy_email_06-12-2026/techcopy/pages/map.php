  ...
  <div>
    ...
    <div class="map-legend">
      ...
      <div style="margin-left:auto;display:flex;align-items:center;gap:6px;flex-wrap:wrap">
        ...
        <button class="layer-btn"        data-layer="carto"  onclick="switchLayer('carto')">🌑 Scuro</button>
        <button class="layer-btn"        data-layer="osmHot" onclick="switchLayer('osmHot')">🎨 HOT</button>
      </div>
    </div>
  </div>
