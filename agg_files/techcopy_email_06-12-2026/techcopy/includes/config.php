...
define('MAIL_FROM',       'noreply@tuodominio.it');
...
define('MAIL_SMTP_USER',  '');             // email mittente SMTP
define('MAIL_SMTP_PASS',  '');             // password / App Password
define('MAIL_SMTP_DEBUG', 0);             // 0=off 1=errori 2=verboso (solo dev)

// Abilita/disabilita l'intero sistema di notifiche email
define('MAIL_ENABLED',    false);          // impostare true dopo aver configurato SMTP
