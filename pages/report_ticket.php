...
<title>Intervento n. <?= str_pad($id,4,'0',STR_PAD_LEFT) ?> — Scrive &amp; Riscrive SRL</title>
...
<div class="toolbar">
  <h2>🖨️ Scrive &amp; Riscrive SRL  — Rapporto Intervento</h2>
...
<div class="report">
  ...
  <div class="report-header">
    <div class="company">
      <h1><img src="/techcopy/assets/img/favicon.png" width="20" height="20"> Scrive &amp; Riscrive SRL</h1>
      <p>Rapporto di Intervento Tecnico</p>
      <p style="margin-top:8px;font-size:11px;color:#4a5568">Generato il: <?= date('d/m/Y H:i') ?></p>
    </div>
    <div class="ticket-ref">
      <div class="num">n.<?= str_pad($t['id'],4,'0',STR_PAD_LEFT) ?></div>
  ...
  <div class="report-body">
    ...
    <div class="signature-area">
      <div class="signature-box">
        <div class="signature-line">Firma Tecnico Responsabile<br><?= h($t['tech_name'] ?? '___________________') ?></div>
      </div>
      <div class="signature-box">
        <div class="signature-line">Firma Cliente<br><?= h($t['client_name'] ?? '___________________') ?></div>
      </div>
    </div>
  ...
  <div class="report-footer">
    <span>Scrive &amp; Riscrive SRL — Rapporto Intervento n.<?= str_pad($id,4,'0',STR_PAD_LEFT) ?></span>
