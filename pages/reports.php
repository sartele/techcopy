...
<div class="table-wrap" style="padding:0;margin-bottom:20px">
  ...
  <div style="padding:16px 20px">
    <form method="GET" style="display:flex;gap:12px;flex-wrap:wrap;align-items:flex-end">
      ...
      <button type="button" class="btn btn-secondary btn-sm" onclick="window.print()">🖨️ Stampa</button>
    </form>
  </div>
</div>
...
<script>
  // Nasconde filtri e pulsanti non necessari in stampa
...
<style>
  @media print {
    /* Nascondi il blocco filtri */
    .table-wrap:first-of-type { display: none !important; }
    /* Nascondi la colonna "Report" (link 📄) nella lista interventi */
    thead th:last-child, tbody td:last-child { display: none !important; }
    /* Forza sfondo bianco e testo scuro */
    body, .stat-card, .table-wrap, table, tr, td, th {
...
@media print {
  ...
  * { box-sizing: border-box !important; }
  ...
  .table-wrap:first-of-type,          /* blocco filtri */
  .btn, button,                        /* tutti i pulsanti */
  nav, header, aside,                  /* navigazione layout */
  thead th:last-child,
  tbody td:last-child { display: none !important; }

  /* Forza tutto in colonna singola — rompe le griglie */
  div[style*="display:grid"],
  div[style*="display: grid"] {
    display: block !important;
  }

  /* KPI cards: 2 per riga invece di 4 */
  .stats-grid {
  ...
  /* Ogni blocco table-wrap va su pagina intera */
  .table-wrap {
    width: 100% !important;
  ...
  /* Tabelle: larghezza piena e font leggibile */
  table {
    width: 100% !important;
  ...
  /* Badge leggibili in bianco/nero */
  .badge {
  ...
  /* Barre distribuzione: assicura che la larghezza % sia visibile */
  ...
  /* Evita tagli a metà riga */
  tr { page-break-inside: avoid; break-inside: avoid; }

  /* Titoli sezione */
  .table-head h4 { font-size: 13px !important; margin: 0 !important; padding: 6px 10px !important; }
}
</style>
<?php layout_footer(); ?>